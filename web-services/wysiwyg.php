...
display name to H1, and copies the contents from the old WYSIWYG to the
new one.
*/
...
try
{
    $folder = $cascade->getAsset( a\Folder::TYPE, "95c90c978b7f08ee71339a16fce55f47" );
